...
class _StepUMKMState extends State<StepUMKM> {
  ...
  void _handleNext() {
    if (_formKey.currentState!.validate()) {
      if (widget.data.fotoUmkmPath == null && widget.data.fotoUmkmUrl == null) {
          // Note: using fotoUmkmUrl check just in case, though currently we use path 
          // usually registration uses path.
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text("Foto UMKM wajib diupload.")),
        );
        return;
      }
        ...
        child: Column(
              children: [
                ...
                _buildTextField(
                  ...
                  validator: (val) => (val == null || val.isEmpty) ? "Nama UMKM wajib diisi." : null,
                ),
